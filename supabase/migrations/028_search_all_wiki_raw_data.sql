-- Migration 028: search_all — include wiki_article content as raw_data
-- Game tables are empty (data lives in wiki_articles content as JSON),
-- so the search_wiki CTE needs to provide content as raw_data for
-- the voice agent to see item attributes.
