    ...
    <section className={containerClass}>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.h2
          ...
          style={{
            background: 'linear-gradient(135deg, hsl(198 100% 65%), hsl(198 100% 85%))',
        ...
        <motion.div
          ...
          style={{ opacity: useTransform(scrollProgress, [0, 0.35, 0.75, 1], [0, 1, 1, 0]), y: useTransform(scrollProgress, [0, 0.4, 0.8, 1], [40, 0, 0, -20]) }}
        >
          <motion.div
            whileHover={{ scale: 1.06, boxShadow: '0 0 30px hsl(198 100% 65% / 0.4)' }}
            whileTap={{ scale: 0.96 }}
