      ...
      <div className={cn("relative", containerClassName)}>
        ...
        >
          <textarea
            ...
            className={cn(
              "peer w-full resize-y bg-transparent px-3 pb-2 pt-5 text-base outline-none placeholder:text-transparent disabled:cursor-not-allowed md:text-sm",
              className
            )}
            placeholder=" "
            {...props}
          ...
          <label
            ...
            className={cn(
              ...
              "peer-placeholder-shown:top-3 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-sm peer-placeholder-shown:text-muted-foreground",
